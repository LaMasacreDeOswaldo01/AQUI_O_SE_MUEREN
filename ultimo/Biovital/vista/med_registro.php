                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="form-group required">
                                ...
                                <input type="text" class="form-control" id="cedula" name="cedula" required placeholder="Ej: 12345678" disabled>
                                <small class="form-text text-muted">Seleccione el tipo de documento primero</small>
                            </div>
                        </div>
                    </div>
