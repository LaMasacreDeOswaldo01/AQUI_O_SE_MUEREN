                    ...
                    <?php if ($current_role === 'administrador'): ?>
                        ...
                        <li class="nav-item">
                            <a href="<?php echo APP_URL; ?>/especialidades" class="nav-link <?php echo ($active_page ?? '') === 'especialidades' ? 'active' : ''; ?>">
                                <i class="nav-icon fas fa-stethoscope"></i><p>Especialidades</p>
                            </a>
                        </li>
                        <li class="nav-item">
                    ...
                    <?php elseif ($current_role === 'medico'): ?>
                        ...
                        <li class="nav-item">
                            <a href="<?php echo APP_URL; ?>/medico/agenda" class="nav-link <?php echo ($active_page ?? '') === 'agenda' ? 'active' : ''; ?>">
                                <i class="nav-icon fas fa-calendar-week"></i><p>Mi Agenda</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo APP_URL; ?>/medico/evoluciones" class="nav-link <?php echo ($active_page ?? '') === 'evoluciones' ? 'active' : ''; ?>">
                                <i class="nav-icon fas fa-notes-medical"></i><p>Evoluciones Clínicas</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="<?php echo APP_URL; ?>/medico/alertas" class="nav-link <?php echo ($active_page ?? '') === 'alertas' ? 'active' : ''; ?>">
                                <i class="nav-icon fas fa-exclamation-triangle"></i><p>Gestión de Alertas</p>
                            </a>
                        </li>
