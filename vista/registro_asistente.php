    ...
    <div class="register-card">
        <div class="register-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2><i class="fas fa-user-nurse me-2"></i> Registro de Asistente</h2>
                ...
                <div id="step3" class="step-content" style="display:none;">
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="adicional" name="adicional" rows="2" 
                                      placeholder="Información adicional sobre el asistente..."></textarea>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-register">
                            <i class="fas fa-check-circle"></i> Crear Cuenta de Asistente
                        </button>
                    </div>
                </div>
...
$(document).ready(function() {
    console.log('=== FORMULARIO DE REGISTRO DE ASISTENTE ===');
