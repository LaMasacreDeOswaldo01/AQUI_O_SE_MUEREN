        ...
        <div class="register-body">
            ...
            <div class="step-indicator" id="stepIndicator">
                ...
                <div class="step" data-step="3">
                    ...
                    <div class="step-label">Profesional y Seguridad</div>
                </div>
            </div>
            ...
            <form id="form-registro">
                ...
                <!-- Paso 3: Datos Profesionales y Seguridad -->
                <div id="step3" class="step-content" style="display:none;">
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control mpps-field" id="mpps_registro" name="mpps_registro" 
                                   placeholder="Ej: MPPS-12345">
                            <small class="form-text text-muted">Número de registro en el Ministerio del Poder Popular para la Salud</small>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="adicional" name="adicional" rows="2" 
                                      placeholder="Especialidad, años de experiencia, consultorio, etc..."></textarea>
                            <small class="form-text text-muted">Comparta información relevante sobre su práctica médica</small>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group required">
                            ...
                            <small class="form-text text-muted">Usaremos este correo para comunicaciones profesionales</small>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-register">
                            <i class="fas fa-check-circle"></i> Crear Cuenta de Médico
                        </button>
                    </div>
                </div>
...
$(document).ready(function() {
    console.log('=== FORMULARIO DE REGISTRO DE MÉDICO ===');
    ...
    // Función para actualizar los IDs de ubicación desde los selects
    ...
    $('#form-registro').submit(function(e) {
        ...
        var datos = {
            ...
            mpps_registro: $('#mpps_registro').val().trim(),
            ...
            // Nombres de ubicación para construir la dirección en el servidor
