            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                    ...
                    <?php if ($current_role === 'administrador'): ?>
                        ...
                        <li class="nav-header">GESTIÓN DE REGISTROS</li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo APP_URL; ?>/registro/medico" class="nav-link">
                                <i class="nav-icon fas fa-user-md"></i>
                                <p>Registro Médico</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo APP_URL; ?>/registro/asistente" class="nav-link">
                                <i class="nav-icon fas fa-user-nurse"></i>
                                <p>Registro Asistente</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo APP_URL; ?>/registro/administrador" class="nav-link">
