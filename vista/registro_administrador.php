<?php
<<<<<<< HEAD
// vista/registro_administrador.php - VERSIÓN CORREGIDA
// Registro de Administrador - Estilo BioVital Dashboard
=======
// vista/registro_administrador.php
// Registro de administradores - Versión con interfaz unificada BioVital
    ...
    <div class="register-card">
        <div class="register-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2><i class="fas fa-user-shield me-2"></i> Registro de Administrador</h2>
...
=======
    <title>Registro de Administrador - BioVital</title>
...
<div class="registro-wrapper">
    ...
    <div class="registro-container rol-admin">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="adicional" name="adicional" rows="2" 
                                      placeholder="Información adicional sobre el administrador..."></textarea>
                        </div>
                    </div>
...
<<<<<<< HEAD
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-register">
                            <i class="fas fa-check-circle"></i> Crear Cuenta de Administrador
                        </button>
                    </div>
                </div>
                ...
                <div class="login-link">
                   <a href="http://localhost/biovital/">
...
$(document).ready(function() {
    console.log('=== FORMULARIO DE REGISTRO DE ADMINISTRADOR ===');
    ...
    function goToStep(step) {
        ...
        currentStep = step;
        $('html, body').animate({ scrollTop: $('.register-card').offset().top - 20 }, 300);
    }
    ...
    $('.btn-next').click(function() {
        ...
        if (nextStep && nextStep <= totalSteps) goToStep(nextStep);
    });
    
    $('.btn-prev').click(function() {
        let prevStep = $(this).data('prev');
        if (prevStep && prevStep >= 1) goToStep(prevStep);
    });
    ...
    function validarPaso1() {
        ...
        if (!nombre) { mostrarError('El nombre es requerido'); $('#nombre').focus(); return false; }
        if (!apellidos) { mostrarError('Los apellidos son requeridos'); $('#apellidos').focus(); return false; }
        if (!fecha_nacimiento) { mostrarError('La fecha de nacimiento es requerida'); $('#fecha_nacimiento').focus(); return false; }
        if (!cedula) { mostrarError('La cédula es requerida'); $('#cedula').focus(); return false; }
        if (!telefono) { mostrarError('El teléfono es requerido'); $('#telefono').focus(); return false; }
        if (!sexo) { mostrarError('Debe seleccionar el sexo'); $('#sexo').focus(); return false; }
    ...
    function validarPaso2() {
        ...
        if (!estado_val) { mostrarError('Debe seleccionar un estado'); $('#estado').focus(); return false; }
        if (!ciudad_val) { mostrarError('Debe seleccionar una ciudad'); $('#ciudad').focus(); return false; }
        if (!direccion_detallada) { mostrarError('Debe ingresar la dirección detallada'); $('#direccion_detallada').focus(); return false; }
    ...
    $('#form-registro').submit(function(e) {
        ...
        if (municipio_nombre && municipio_nombre !== 'Seleccione un municipio...' && municipio_nombre !== 'Primero seleccione un estado...') direccion_completa += (direccion_completa ? ', ' : '') + municipio_nombre;
        if (parroquia_nombre && parroquia_nombre !== 'Seleccione una parroquia...' && parroquia_nombre !== 'Primero seleccione un municipio...') direccion_completa += (direccion_completa ? ', ' : '') + parroquia_nombre;
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if(response.success) {
                    ...
                    if (response.data && response.data.errors) errorMsg = Object.values(response.data.errors).join('. ');
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.5.2/dist/js/bootstrap.bundle.min.js"></script>
<script src="<?php echo APP_URL; ?>/js/registro_administrador.js"></script>
<script src="<?php echo APP_URL; ?>/js/registro_ubicacion.js"></script>
>>>>>>> 08fa34e7676afef1b6a097b9607f3411a6663e15
</body>
</html>